              ...
              child: Column(
                ...
                children: <Widget>[
                  Center(
                    child: Column(
                      children: <Widget>[
                        RatelMedallion(icon: Icons.sentiment_satisfied_alt, background: tk.warningBg, foreground: tk.brand, size: 74, iconSize: 42),
                        const SizedBox(height: RatelSpacing.xs),
                        Text(S.t('profile_name', 'raj_learns'), style: TextStyle(color: tk.text, fontSize: 17, fontWeight: FontWeight.w600)),
                        Text(S.t('profile_joined', 'Joined 2025 · 🇮🇳'), style: TextStyle(color: tk.textMuted, fontSize: 10)),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: tk.successBg, border: Border.all(color: tk.primary, width: 1.5), borderRadius: BorderRadius.circular(tk.radiusLg)),
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(S.t('profile_score', 'English Score · 95'), style: TextStyle(color: tk.success, fontSize: 13, fontWeight: FontWeight.w600)),
                              Text(S.t('profile_score_sub', 'B1 · view breakdown'), style: TextStyle(color: tk.success, fontSize: 10)),
                            ],
                          ),
                        ),
                        Icon(Icons.chevron_right, size: 18, color: tk.success),
                      ],
                    ),
                  ),
                  const SizedBox(height: RatelSpacing.md),
                  Text(S.t('profile_badges', 'Recent badges'), style: TextStyle(color: tk.textMuted, fontSize: 10, fontWeight: FontWeight.w600)),
                  const SizedBox(height: RatelSpacing.sm),
                  Row(
                    children: <Widget>[
                      badge(Icons.local_fire_department, tk.brand, tk.warningBg),
                  ...
                  const SizedBox(height: RatelSpacing.md),
                  RatelButton.neutral(icon: Icons.edit_outlined, label: S.t('profile_edit', 'Edit profile'), onPressed: () {}),
                ],
              ),
            ),
          ),

...
class ScreenIndexScreen extends StatelessWidget {
  ...
  static const List<(String, List<(String, String)>)> _sections =
      <(String, List<(String, String)>)>[
        ...
        (
          'Page 6 · Profile, account & monetization',
          <(String, String)>[
            ('1 · Profile', '/profile'),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          const Expanded(
                            child: Text(
                              'Walk the app — Splash → Welcome → Auth → Home',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 13,
